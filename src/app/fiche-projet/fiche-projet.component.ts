...
this.Vente_digestat_solide_n1=this.produit2(this.isNanFunction(this.Prix_digestat_Solide),this.isNanFunction(this.Quantite_digestat_Solide));
this.Vente_digestat_liquide_n2=this.produit2(this.Vente_digestat_solide_n1,(1+0.01))
this.Vente_Biomethane_n3=this.produit2(this.Vente_digestat_solide_n2,(1+0.01))
this.Vente_Biomethane_n4=this.produit2(this.Vente_digestat_solide_n3,(1+0.01))
this.Vente_Biomethane_n4=this.produit2(this.Vente_digestat_solide_n3,(1+0.01))
...
this.Total_autres=this.isNanFunction(this.Hypotheque)
  ...
  console.log("Total_autres",this.Total_autres,this.isNanFunction(this.Hypotheque),
  this.isNanFunction(this.bfr_consommable),this.isNanFunction(this.Audit_Technique),this.isNanFunction(this.In_Front_Oblig));

this.total_invest =this.isNanFunction(this.constructions[0].Tab_140.Ouverture_chantier.Sous_Total_Prix_vente ) + this.isNanFunction(this.constructions[0].Tab_140.Lot_1_Process_methanisation.Sous_Total_Prix_vente) +
this.isNanFunction(this. constructions[0].Tab_140.Lot_2_Valorisation.Sous_Total_Prix_vente )+ this.isNanFunction(this.constructions[0].Tab_140.Lot_3_Terrassement_Grande_Masse_Talutage_VRD.Sous_Total_Prix_vente )+
this.isNanFunction(this.constructions[0].Tab_140.Lot_4_Genie_Civil_circulaire_digestat_liquide_couverture_simple.Sous_Total_Prix_vente) +
  this.isNanFunction(this.constructions[0].Tab_140.Lot_5_Genie_Civil_ouvrages_peripheriques.Sous_Total_Prix_vente )+
    this.isNanFunction(this.constructions[0].Tab_140.Lot_6_Charpente_Batiment_Couverture.Sous_Total_Prix_vente )+
      this.isNanFunction(this.constructions[0].Tab_140.Lot_7_Courant_fort_Soutirage_Electricite_Generale.Sous_Total_Prix_vente) +
        this.isNanFunction(this.constructions[0].Tab_140.Maitrise_oevre.Sous_Total_Prix_vente )+
          this.isNanFunction(this.constructions[0].Tab_140.Assistance_maitrise_ouvrage.Sous_Total_Prix_vente) +
...
this.Suivi_de_chantier+this.In_Front_Oblig , 0.0215)
...
this.CAPITAL_APPORT_COMPTE_COURANt=this.produit2((this.FONDS_PROPRES - this.SUBVENTION) , 0.01)
console.log("CAPITAL_APPORT_COMPTE_COURANt",this.CAPITAL_APPORT_COMPTE_COURANt);
this.EMPRUNT_CAPITAL=this.FONDS_PROPRES - this.SUBVENTION - this.CAPITAL_APPORT_COMPTE_COURANt
this.EMPRUNT_LONG_ERME=
this.total_invest - this.FONDS_PROPRES

//TOTAL_FINANCEMENTS

this.TOTAL_FINANCEMENTS=this.isNanFunction(this.FONDS_PROPRES)
+this.isNanFunction(this.LOCATION_VENTE_CONSTRUCTEUR)
+this.isNanFunction(this.EMPRUNT_LONG_ERME)

console.log("TOTAL_FINANCEMENTS",this.TOTAL_FINANCEMENTS,
...
else  if(this.ss>191 && this.ss <=240 )
{
  ...
  this.bfr_consommable=this.D.Tab240.tabExploi_240_ChargesConsommables.Charbon_actif.an
...
else  if(this.ss>241 && this.ss <=280 )
{
  ...
  this.bfr_consommable=this.D.Tab280.tabExploi_280_ChargesConsommables.Charbon_actif.an
...
else  if(this.ss>281 && this.ss <=560 )
{
  ...
  this.bfr_consommable=this.D.Tab560.tabExploi_560_ChargesConsommables.Charbon_actif.an
...
else  if(this.ss>561 && this.ss <=760 )
{
  ...
  this.bfr_consommable=this.D.Tab760.tabExploi_760_ChargesConsommables.Charbon_actif.an
...
{this.D=this.exploitations[6];
  this.bfr_consommable=this.D.Tab960.tabExploi_960_ChargesConsommables.Charbon_actif.an
...
{this.D=this.exploitations[7];
  this.bfr_consommable=this.D.Tab1120.tabExploi_1120_ChargesConsommables.Charbon_actif.an
  ...
  for(j=0;j<tabX.length;j++){
    ...
    if(this.volume_Nm3_CH4_an<=i) {
     ...
     // console.log(this.volume_Nm3_CH4_an, i + this.quotion(this.produit2((val-j),((i+1)-i)), ((j+1)-j)));
      return  this.prixLineaire=  i + this.quotion(this.produit2((val-j),((i+1)-i)), ((j+1)-j))
    }
  }
}
